...
class TextureUnmanaged : public ::Texture {
 public:
     ...
     */
    inline TextureUnmanaged& Update(::RayRectangle rec, const void *pixels) {
     ...
     * @see ::DrawTextureRec()
     */
    inline void Draw(::RayRectangle sourceRec, ::Vector2 position = {0, 0},
            ::Color tint = {255, 255, 255, 255}) const {
     ...
     * @see ::DrawTextureQuad()
     */
    inline void Draw(::Vector2 tiling, ::Vector2 offset, ::RayRectangle quad,
            ::Color tint = {255, 255, 255, 255}) const {
     ...
     * @see ::DrawTexturePro()
     */
    inline void Draw(::RayRectangle sourceRec, ::RayRectangle destRec, ::Vector2 origin = {0, 0},
     ...
     */
    inline void Draw(::NPatchInfo nPatchInfo, ::RayRectangle destRec, ::Vector2 origin = {0, 0},
            float rotation = 0, ::Color tint = {255, 255, 255, 255}) const {
     ...
     */
    inline void DrawTiled(::RayRectangle sourceRec, ::RayRectangle destRec, ::Vector2 origin = {0, 0},
     ...
     */
    inline void DrawBillboard(const ::Camera& camera,
            ::RayRectangle source, ::Vector3 position, ::Vector2 size,
            ::Color tint = {255, 255, 255, 255}) const {
     ...
     */
    inline void DrawBillboard(const ::Camera& camera,
            ::RayRectangle source, Vector3 position,
     ...
     */
    inline void DrawCube(::RayRectangle source, ::Vector3 position, float width, float height, float length,
            ::Color color = {255, 255, 255, 255}) const {
     ...
     * @see ::DrawCubeTextureRec()
     */
    inline void DrawCube(::RayRectangle source, ::Vector3 position, ::Vector3 dimensions,
            ::Color color = {255, 255, 255, 255}) const {
     ...
     */
    inline TextureUnmanaged& SetShapes(const ::RayRectangle& source) {
