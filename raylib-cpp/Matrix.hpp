...
class Matrix : public ::Matrix {
 public:
    ...
    static Matrix Frustum(double left, double right, double bottom, double top,
            double raynear, double rayfar) {
        return ::MatrixFrustum(left, right, bottom, top, raynear, rayfar);
    }

    static Matrix Perspective(double fovy, double aspect, double raynear, double rayfar) {
        return ::MatrixPerspective(fovy, aspect, raynear, rayfar);
    }

    static Matrix Ortho(double left, double right, double bottom, double top,
            double raynear, double rayfar) {
        return ::MatrixOrtho(left, right, bottom, top, raynear, rayfar);
    }
