...
class Font : public ::Font {
 public:
     ...
     */
    inline void RayDrawText(const std::string& text, ::Vector2 position, float fontSize,
     ...
     * Draw text using font and additional parameters.
     */
    inline void RayDrawText(const std::string& text, int posX, int posY, float fontSize,
            float spacing, ::Color tint = WHITE) const {
        ::RayDrawTextEx(*this, text.c_str(),
     ...
     */
    inline void RayDrawText(int codepoint,
            ::Vector2 position,
            float fontSize,
     ...
     */
    inline void RayDrawText(const int *codepoints,
