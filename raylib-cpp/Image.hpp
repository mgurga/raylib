...
class Image : public ::Image {
 public:
    ...
    inline void DrawRayRectangle(int posX, int posY, int width, int height,
            ::Color color = {255, 255, 255, 255}) {
        ::ImageDrawRayRectangle(this, posX, posY, width, height, color);
    }

    inline void DrawRayRectangle(Vector2 position, Vector2 size,
            ::Color color = {255, 255, 255, 255}) {
        ::ImageDrawRayRectangleV(this, position, size, color);
    }

    inline void DrawRayRectangle(::RayRectangle rec, ::Color color = {255, 255, 255, 255}) {
        ::ImageDrawRayRectangleRec(this, rec, color);
    }

    inline void DrawRayRectangleLines(::RayRectangle rec, int thick = 1,
            ::Color color = {255, 255, 255, 255}) {
        ::ImageDrawRayRectangleLines(this, rec, thick, color);
    }

    inline void Draw(const ::Image& src, ::RayRectangle srcRec, ::RayRectangle dstRec,
            ::Color tint = {255, 255, 255, 255}) {
        ::ImageDraw(this, src, srcRec, dstRec, tint);
    }

    inline void RayDrawText(const std::string& text, ::Vector2 position, int fontSize,
            ::Color color = {255, 255, 255, 255}) {
        ::ImageRayDrawText(this,
            text.c_str(),
    ...
    inline void RayDrawText(const std::string& text, int x, int y, int fontSize,
            ::Color color = {255, 255, 255, 255}) {
        ::ImageRayDrawText(this, text.c_str(), x, y, fontSize, color);
    }
